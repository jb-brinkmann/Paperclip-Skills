...
`For ea-direkt brand, CI, tone, UI, visual, claim, logo, color, typography, and messaging decisions, use the skill ea-direkt-brand. The only authoritative detailed source is ea-direkt_Branding-CI-Dokument(1).docx. Do not maintain copied CI details in these instructions.`
