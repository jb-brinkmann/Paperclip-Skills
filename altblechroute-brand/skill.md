...
- If agent instructions contain Altblechroute colors, typography, logo rules, claims, tone, UI style, image style, or messaging, delete those details and replace them with a reference to this skil[...]
...
`For Altblechroute brand, CI, tone, UI, visual, claim, logo, color, typography, and messaging decisions, use the skill altblechroute-brand. The only authoritative detailed source is Altblechroute_[...]
